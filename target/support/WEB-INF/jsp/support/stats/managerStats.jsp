...
<div id="managerStatsRootLayer" data-opener-data="<c:out value='${param.openerData}'/>"
     data-json="<c:out value='${param.jsonData}'/>">
    <div class="clearfix border rounded bg-gray-light p-2">
        <div class="row">
            <div class="col-md-11">
                <form id="managerStatsSchFrm0" method="post" class="form-horizontal">
            ...
            <div class="col-md-1 d-none d-sm-block align-self-center">
                <div class="row p-1">
                    <button class="btn btn-outline-primary btn-sm p-1" type="button" id="managerStatsResetBtn1"><i
                            class="fa fa-undo"></i> RESET
                    </button>
                </div>
                <div class="row p-1">
                    <button class="btn btn-primary btn-sm p-1" type="button" id="managerStatsSearchBtn1"><i
                            class="fa fa-search"></i> SEARCH
                    </button>
                </div>
            </div>
            <div class="col-sm-3 d-block d-sm-none">
                <button class="btn btn-primary btn-sm" type="button" id="managerStatsSearchSmBtn"><i
                        class="fa fa-search"></i> SEARCH
                </button>
                <button class="btn btn-outline-primary btn-sm" type="button" id="managerStatsResetSmBtn"><i
                        class="fa fa-undo"></i> RESET
                </button>
            </div>
        </div>
    ...
    <div class="data-table clearfix">
        <div class="row p-1">
            <div class="col-md-6">
                <ol class="breadcrumb text-xs bg-gray-light" id="managerStatsBreadcrumb">
...
<%--                    <li class="breadcrumb-item active">담당자 현황</li>--%>
        ...
        <div class="row">
            <div class="col-lg-12">
                <table class="table table-sm table-hover text-sm border-bottom bg-white" id="managerStats" style="display: none;">
                    ...
                    <thead>
                    <tr>
                        <th class="text-center" scope="col" rowspan="2">담당자</th>
                    ...
                    <tbody>
                    <tr>
                        <td colspan="5" scope="row" class="text-center">NO DATA</td>
                    </tr>
                    </tbody>
                    <tfoot></tfoot>
                </table>
                <table class="table table-sm table-hover text-sm border-bottom bg-white" id="customerStats" style="display:none;">
...
<script src="<c:url value='/js/module/support/stats/managerStats.js?v='/><c:out value='${sysTimeMillis}'/>"></script>