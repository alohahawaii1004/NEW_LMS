...
<div id="customerMngRootLayer" data-opener-data="<c:out value='${param.openerData}'/>"
    ...
    <div class="clearfix border rounded bg-gray-light p-2">
        <div class="row">
                ...
                <form id="customerMngSchFrm0" method="post" class="form-horizontal">
                    <div class="row" id="bbsSearchArea">
                        ...
                        <div class="form-group col-md-4">
                            <div class="row">
                                <label class="col-sm-3 col-form-label col-form-label-sm d-none d-sm-block"
                                       data-term="L.사용여부"></label>
                                <div class="col-sm-9">
                                    <select class="form-control form-control-sm" name="schUseYn">
                                        <option value=""> Use Yn Select </option>
            ...
            <div class="col-md-1 d-none d-sm-block align-self-center">
                <div class="row p-1">
                    <button class="btn btn-outline-primary btn-sm p-1" type="button" id="customerMngResetBtn1"><i
            ...
            <div class="col-sm-3 d-block d-sm-none">
                ...
                <button class="btn btn-outline-primary btn-sm" type="button" id="customerMngResetSmBtn"><i
                        class="fa fa-undo"></i> RESET
                </button>
            </div>
        </div>
        ...
        <div class="row p-1">
            ...
            <div class="col-md-6 text-right">
                <div class="main-btn-grp1">
                    <button type="button" class="btn btn-primary btn-sm" id="customerMngAddBtn1" data-term="B.REG"><i
...
<script src="<c:url value='/js/module/support/customer/customerList.js?v='/><c:out value='${sysTimeMillis}'/>"></script>