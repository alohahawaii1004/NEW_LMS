...
var CustomerList = function(){
    ...
    let $rootNode = $("#customerMngRootLayer");
    let $schForm = $("#customerMngSchFrm0", $rootNode);
    let $grid = $("#customerMngList1", $rootNode);
    ...
    let initGrid = function(){
        $grid.datagrid({
            ...
            columns: [[
                ...
                , {field: "orgId", title: paragonCmm.getLang("L.아이디"), formatter: filterXSS, halign: "CENTER", align: "CENTER", width: "20%" }
                , { field: "orgNm", title: paragonCmm.getLang("L.회사명"), formatter: filterXSS, halign: "CENTER", align: "LEFT", width: "59%" }
                , { field: "useYn", title: paragonCmm.getLang("L.사용여부"), formatter: filterXSS, halign: "CENTER", align: "CENTER", width: "20%", styler: useYnStyler }
            ]],
    ...
    let setBtnEvent = function(){
        ...
        $rootNode.on("click", "button", function(){
            ...
            switch (btnId){
                ...
                case "closeBtn":
                case "customerListCloseBtn":
                    closeWindow();
                    break;
                case "selectBtn":
                case "customerListSelectBtn":
                    select();
                    break;
