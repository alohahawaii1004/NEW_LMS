...
<div class="container-fluid" id="colsInfo" data-opener-data="<c:out value='${param.openerData}'/>">
    ...
    <div class="clearfix border rounded bg-gray-light p-2">
        <div class="row scrolling-wrapper flex-row flex-nowrap m-2" id="target">
        </div>
    ...
    <div class="form-row p-1" id="btnLayer">
        ...
        <div class="col-md-6 text-right">
            ...
            <button class="btn btn-default btn-sm" id="colsInitBtn" data-term="B.INIT"><i class="fa fa-refresh"></i> </button>
            <button class="btn btn-primary btn-sm" id="colsSaveBtn" data-term="B.SAVE"><i class="fa fa-save"></i> </button>
        </div>
    </div>
</div>
<script src="<c:url value='/js/module/cmm/modal/columnMngModal.js'/>"></script>