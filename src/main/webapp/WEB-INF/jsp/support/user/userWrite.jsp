...
<div id="userMngWriteRootLayer" class="container-fluid" data-opener-data="<c:out value='${param.openerData}'/>"
                ...
                <div class="col-md-12 particle-row">
                    <div class="row">
                        ...
                        <div class="col-sm-10 particle-form">
                            <input type="text" class="particle-input" name="loginId" placeholder="login ID" data-col="loginId" maxlength="80" required>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 particle-row">
    ...
    <div class="row p-2">
        ...
        <div class="col-md-6 text-right">
            ...
            <button type="button" class="btn btn-primary btn-sm" id="userMngWriteSaveBtn"><i class="fa fa-pencil"></i> 등록</button>
        </div>
    </div>
</div>
<%@ include file="/WEB-INF/tiles/include/jsRsaLink.jsp"%>
<script src="<c:url value='/js/module/support/user/userWrite.js?v='/><c:out value='${sysTimeMillis}'/>"></script>