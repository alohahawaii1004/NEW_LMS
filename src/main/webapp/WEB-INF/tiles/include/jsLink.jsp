...
<!-- chart js -->
<script src="<c:url value="/js/vendor/chart-js/4.3.0/dist/chart.umd.js"/>"></script>
...
<script src="<c:url value='/js/vendor/paragon/4.5.0/plugins/easyui.extension.js'/>"></script>
...
//              var styleStr = "width:"+lastWidth.toFixed(0)+"%";
    ...
    var pageResize = function () {
        ...
        $(".schBoxBtn").height($(".schBox").height());

        //--CKEDITOR 리사이즈
        for (instance in CKEDITOR.instances)
            CKEDITOR.instances[instance].resize('100%', '150px', true);
    }
    //-- 로그인 세션 정보 셋팅
    var loadSession = function(){
        ...
        if(loginInfo == null){
            var initAuth = function(json){
                loginInfo = json.data;
                paragonCmm.formMap.set("loginInfo",loginInfo);
            }
