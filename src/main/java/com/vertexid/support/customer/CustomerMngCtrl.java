/*
 * @(#)CustomerMngCtrl.java     2023-03-13 013 오전 9:55:06
 *
...
import com.vertexid.support.issue.IssueMngSvc;
 ...
 */
@Controller
public class CustomerMngCtrl extends BaseCtrl {
    ...
    @Resource
    CustomerMngSvc customerMngSvc;

    @RequestMapping(value = "/support/customer/customerMng/listPerPage/json",
    ...
    public String getListPerPage(ModelMap modelMap,
        ...
        listPerPageFunction.setNamespace(CustomerMngSvc.NAMESPACE);
    ...
    @RequestMapping(value = "/support/customer/customerMng/saveData/json")
    public String saveCustomerInfo(ModelMap modelMap,
            @RequestBody
            CustomerDTO param) {
        return getTransactionJsonView(modelMap,
                customerMngSvc.saveInfo(param));
    }
